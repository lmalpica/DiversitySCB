...
sumunder$country <- c("Rest of the world")
...
my.barplotC<-ggplot(mydat, aes(x=ordered(mydat$country, levels = c("United States of America", "Canada", "Australia", "United Kingdom", "Rest of the world")), y=percent.members, 
